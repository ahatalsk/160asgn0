...
class Vector3 {
    ...
    add(other) {
        ...
        // Gets the elements of each vector
        s = other.elements;
        d = this.elements;
        
        // Goes through each element array and adds the values together
        for (i = 0; i < 3; ++i) {
          d[i] = d[i] + s[i];
        }
    ...
    sub(other) {
        ...
        // Goes through each element array and subtracts the values
        for (i = 0; i < 3; ++i) {
          d[i] = d[i] - s[i];
        }
        // This function should change this vector (this.elements) and not create a new vector.
    ...
    div(scalar) {
        ...
        // Goes through each element of the array and divides by the scalar
        for (i = 0; i < 3; ++i) {
          d[i] = d[i] / scalar;
        }
        // This function should change this vector (this.elements) and not create a new vector.
    ...
    mul(scalar) {
        ...
        // Goes through each element of the array and multiplies by the scalar
        for (i = 0; i < 3; ++i) {
          d[i] = d[i] * scalar;
        }
        // This function should change this vector (this.elements) and not create a new vector.
    ...
    static dot(other1, other2) {
        ...
        // Go through the elements, multiply them together and acumulate the total
        for (i = 0; i < 3; ++i) {
          d = d + (a[i] * b[i]);
        }
    ...
    magnitude() {
        ...
        let m = Math.sqrt(d[0]**2 + d[1]**2 + d[2]**2);
    ...
    normalize() {
        ...
        // Gets the elements and finds the magnitude
        d = this.elements;
        m = this.magnitude();
        
        // Goes through each element of the array and divides by the magnitude
        for (i = 0; i < 3; ++i) {
          d[i] = d[i] / m;
        }
